const ERROR_FILE_TOO_SMALL = 'Not a valid Snapmatic file (file too small)';

const ERROR_INVALID_SNAPMATIC_FILE = 'Not a valid Snapmatic file (converted file not JPEG)';
